...
class OrderItemTest {
    ...
    void constructor_acceptsValidItem() {
        ...
        assertEquals(new Quantity(2), item.quantity());
    }
    ...
    void constructor_rejectsNullProductId() {
        assertThrows(IllegalArgumentException.class, () ->
                new OrderItem(null, "Test", new Money(BigDecimal.TEN), null, new Quantity(1)));
    }

    @Test
    void constructor_rejectsNullProductName() {
        assertThrows(IllegalArgumentException.class, () ->
                new OrderItem(new ProductId(1), null, new Money(BigDecimal.TEN), null, new Quantity(1)));
    }

    @Test
    void constructor_rejectsBlankProductName() {
        assertThrows(IllegalArgumentException.class, () ->
                new OrderItem(new ProductId(1), "   ", new Money(BigDecimal.TEN), null, new Quantity(1)));
    }

    @Test
    void constructor_rejectsNullUnitPrice() {
        assertThrows(IllegalArgumentException.class, () ->
                new OrderItem(new ProductId(1), "Test", null, null, new Quantity(1)));
    }

    @Test
    void constructor_rejectsZeroQuantity() {
        assertThrows(IllegalArgumentException.class, () ->
                new OrderItem(new ProductId(1), "Test", new Money(BigDecimal.TEN), null, new Quantity(0)));
    }
